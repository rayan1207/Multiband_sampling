...
void AmiGraph::reset_alphas(graph_t &g){
...
void AmiGraph::label_indep_alpha(edge_t &e, graph_t &g){
...
void AmiGraph::assign_cons_alpha(graph_t &g, vertex_t &vin, edge_t &fermi_one, edge_t &fermi_two, edge_t &bose){
