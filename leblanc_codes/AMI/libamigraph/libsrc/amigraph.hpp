#include "mpi.h"  // technically doesn't do anything with mpi... so... unsure about this. Moved bc functions into libamigraph so it is now useful. #include "mpi.h"  // technically doesn't do anything with mpi... so... unsure about this. Moved bc functions into libamigraph so it is now useful. 
...
////////////////////////////////////////////////////
//Rayan's code
void Rfind_fermionic_edges(graph_t &g, edge_vector_t &vector);
void Rfind_bosonic_edges(graph_t &g, edge_vector_t &vector);
